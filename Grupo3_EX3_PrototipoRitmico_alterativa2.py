# EX3.MC - Alternativa 2: Kick tum tum
from music import *
...
score = Score("Alternativa 2: Kick tum tum", tempo)
...
def variarPercusion(bombo, hiHat, vuelta, repeticiones, seccion):
    ...
    tomBase = [REST, FLOOR_TOM, FLOOR_TOM, REST] * 4
    tom = list(tomBase)
...
View.sketch(score)
Play.midi(score)
Write.midi(score, "Grupo3_EX3_PrototipoRitmico_alterativa2.mid")
