# EX3.MC - Alternativa 3: Kick tum1 tum2
from music import *
...
score = Score("Alternativa 3: Kick tum1 tum2", tempo)
...
def variarPercusion(bombo, hiHat, vuelta, repeticiones, seccion):
    ...
    tomBase = [REST, TOM_MEDIO, FLOOR_TOM, REST] * 4
    tom = list(tomBase)
    ...
    if seccion in ("B", "Aprima"):
        bombo = [BDR, REST, REST, BDR, BDR, REST, REST, REST] * 2
...
View.sketch(score)
Play.midi(score)
Write.midi(score, "Grupo3_EX3_PrototipoRitmico_alterativa3.mid")
